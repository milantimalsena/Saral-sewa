...
class Service(models.Model):
    ...
    steps = models.JSONField(default=list, help_text='List of process steps')
    required_documents = models.JSONField(default=list, help_text='List of required documents')
    online_link = models.URLField(null=True, blank=True, help_text='Online registration/application link')
